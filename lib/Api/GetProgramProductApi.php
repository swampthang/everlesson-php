...
/**
 * GetProgramProductApi Class Doc Comment
 *
 * @category Class
 * @package  Everlesson
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GetProgramProductApi
{
     ...
     */
    public function getProgramProduct($token, $membership_id, $program_id)
    {
        list($response, $statusCode, $httpHeader) = $this->getProgramProductWithHttpInfo ($token, $membership_id, $program_id);
        return $response; 
    }


    /**
     * getProgramProductWithHttpInfo
     *
     * 
     *
     * @param string $token token (required)
     ...
     * @throws \Everlesson\ApiException on non-2xx response
     */
    public function getProgramProductWithHttpInfo($token, $membership_id, $program_id)
    {
        
        // verify the required parameter 'token' is set
        if ($token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $token when calling getProgramProduct');
        }
        // verify the required parameter 'membership_id' is set
        if ($membership_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $membership_id when calling getProgramProduct');
        }
        // verify the required parameter 'program_id' is set
        if ($program_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $program_id when calling getProgramProduct');
        }
  
        // parse inputs
        $resourcePath = "/getProgramProduct";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        if ($program_id !== null) {
            ...
            $formParams['program_id'] = $this->apiClient->getSerializer()->toFormValue($program_id);
