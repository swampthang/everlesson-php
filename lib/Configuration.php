...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://api.memberportal.io/v0';
     ...
     * @var string
     */
    protected $userAgent = "PHP-Swagger/1.0.3";
    ...
    {
        $report  = "PHP SDK (Everlesson) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
        $report .= "    PHP Version: ".phpversion()."\n";
        $report .= "    OpenAPI Spec Version: 1.0.3\n";
